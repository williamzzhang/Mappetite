...
(async () => {
  ...
  //EFFECTS: Retrieves recent tweets about Vancouver food, restaurants, recipes, etc. in an array of data
  T.get('search/tweets', { q: '#food, #vancouver since:2020-04-15', count: 100 }, function(err, data, response) {
